...
rf_pred_test = './training_images/rf_train_predict.npy'
cnn_pred_test = '../../../../train/predict/pred_train_masks.npy'
masks_npy_path = '../../../../train/data/prepped/imgs_mask_train.npy'
cnn_test_names_path = '../../../../train/data/prepped/train_names.csv'
rf_test_names_path = './csvs/rf_train_names.csv'
